...
async function connectToWalletConnect() {
    ...
    if (typeof WalletConnectProvider !== 'undefined') {
        ...
        try {
            ...
            // Validar participación (pasando la instancia de web3 específica)
        ...
        alert('Proveedor de WalletConnect no disponible');
    }
}
